...
module "node_provisioning" {
  ...
  nodes = {
    ...
    "dgx-06" = {
      mac           = "10:70:FD:BD:6E:8D"
      ipmi_ip       = "10.229.10.12"
      category      = "default"
  ...
  oob_network_name        = "ipminet"
  software_image_name     = "dgxos-h100-image"
...
module "node_reprovisioning" {
  ...
  management_network_name = "dgxnet"
  oob_network_name        = "ipminet"
  software_image_name     = "dgxos-h100-image"  # Updated image
  bmc_username            = var.bmc_username
  bmc_password            = var.bmc_password
