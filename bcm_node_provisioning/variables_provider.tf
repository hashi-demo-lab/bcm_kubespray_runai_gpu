# BCM Provider Variables for Standalone Testing
#
# These variables are only needed when running this module standalone
# (not as a child module called from root).
